...
namespace CRMEDU.Data.Migrations
{
    ...
    [Migration("20220725111459_AddedReferences")]
            ...
            modelBuilder.Entity("CRMEDU.Domain.Entities.Teachers.Teacher", b =>
                {
                    ...
                    b.HasOne("CRMEDU.Domain.Entities.Courses.Class", null)
                        .WithOne("Teacher")
                        .HasForeignKey("CRMEDU.Domain.Entities.Teachers.Teacher", "ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
